...
public class DocumentDao {
    ...
    public String create(Document document, String userId) {
        ...
        document.setScoresum(0);
        document.setScorecount(0);
    ...
    public DocumentDto getDocument(String id, PermType perm, List<String> targetIdList) {
        ...
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        StringBuilder sb = new StringBuilder("select distinct d.DOC_ID_C, d.DOC_TITLE_C, d.DOC_DESCRIPTION_C, d.DOC_SUBJECT_C, d.DOC_IDENTIFIER_C, d.DOC_PUBLISHER_C, d.DOC_FORMAT_C, d.DOC_SOURCE_C, d.DOC_TYPE_C, d.DOC_COVERAGE_C, d.DOC_RIGHTS_C, d.DOC_CREATEDATE_D, d.DOC_UPDATEDATE_D, d.DOC_LANGUAGE_C, d.DOC_SCORESUM_C, d.DOC_SCORECOUNT_C, ");
        ...
        documentDto.setScoresum(((Number) o[i++]).intValue());
        documentDto.setScorecount(((Number) o[i++]).intValue());
